         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
				...
				<tr>
                    ...
                    <td>
                        <select id="select" name="proCatId">
                            ...
                            <option 
                                <?php
                                    if ($value['proCatId'] == $result['proCatId']) {?>
                                        selected = "selected" 
                                  <?php  } ?>
                               

                            value="<?php echo $result['proCatId'];?>"><?php echo $result['proCatName'];?>
                            </option>
                            <?php } }?>
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <img src="<?php echo $value['image'];?>" height="120px" width="200px"><br/>
