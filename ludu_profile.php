...
<?php include 'include/header.php'; ?>
		...
		<div id="sportsbody" class="maincontent clear">
			<div class="navsports  clear">
				<ul>
					...
					<li><a id="active1" href="ludu.php">Ludo</a></li>
				</ul>
			</div>
                    <div class="pr_body clear">
                        <center>
						<form class="form" action="ludu_profile.php" method="post" enctype="multipart/form-data" autocomplete="off">                          
						<table id="cr_tb">
	...
	<div class="sidebar clear">
		<div class="search">
			<input id="src" type="text" placeholder="Search Ludo Player" name="search"/><span><button class="button2" type=button>Search</button></span>

		</div>
			<div id="side" class="samesidebar clear">
				<img src="images/ludo_tshirt.jpg" style="width:253px"/>
				
			</div>
			<img src="images/love_ludo.jpeg" style="width:253px; height:70px"/>
			<div id="side1" class="samesidebar clear">
					<div class="bd_jursey clear">
						<img src="images/ludo_tshirt1.jpg" style="width:250px; height:200px" />
					</div>
					<img id="love_cr" src="images/ludo-logo.jpg" style="width:250px; height:60px"/
