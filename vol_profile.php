			...
			<div class="navsports  clear">
				<ul>
                    ...
                    <div class="pr_body clear">
                        <center>
						<form class="form" action="vol_profile.php" method="post" enctype="multipart/form-data" autocomplete="off">                          
						<table id="cr_tb">
                                 ...
                                 <tr id="cr_tr">
                                    ...
                                    <td class="action">
                                        : <select id="cr_sel" name="POSITION">
                                            <option value="position">--Choose Your Position--</option>
	...
	<div class="sidebar clear">
		<div class="search">
			...
			<div id="side" class="samesidebar clear">
				<img src="images/vol_tshirt.jpg" style="width:253px"/>
				
			</div>
			<img src="images/vd.jpg" style="width:253px; height:50px"/>
			<div id="side1" class="samesidebar clear">
					<div class="bd_jursey clear">
						<img src="images/vol_tshirt1.jpg" style="width:250px; height:200px" />
					</div>
					<img id="love_cr" src="images/love_vol.jpg" style="width:250px; height:70px"/
