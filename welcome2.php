		...
		<div id="sportsbody" class="maincontent clear">
			<div class="navsports  clear">
				<ul>
					...
					<li><a id="active1" href="volley.html">Volley</a></li>
...
<div style="padding:10px; color:green; font-size:16px" class="alert alert-success"><?= $_SESSION['message'] ?></div>
   ...
   <h2 id="wlimg"> Welcome <span style="color:blue" class="user"><?= $_SESSION['NAME'] ?></span></h2>
	...
	<h1 style="padding-left:140px; color:#008465">Your Volley  Profile </h1>
	<table id="wel_tab">
	<center>
		<tr id="tb_st">
			<td>Name</td>
    ...
    ?>
		...
		<div class="sidebar clear">
			...
			<img src="images/love_vol.jpg" style="width:253px; height:50px"/><br/>
			<img src="images/volley10.gif" style="width:100px; height:150px; padding-left:70px"/>
