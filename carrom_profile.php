...
<?php include 'include/header.php'; ?>
			...
			<div class="navsports  clear">
				<ul>
                    ...
                    <div class="pr_body clear">
                        <center>
						<form class="form" action="carrom_profile.php" method="post" enctype="multipart/form-data" autocomplete="off">                          
						<table id="cr_tb">
	...
	<div class="sidebar clear">
		<div class="search">
			<input id="src" type="text" placeholder="Search Carrmboard Player" name="search"/><span><button class="button2" type=button>Search</button></span>

		</div>
			<div id="side" class="samesidebar clear">
				<img src="images/carrom_tshirt1.jpg" style="width:253px"/>
			...
			<div id="side1" class="samesidebar clear">
					<div class="bd_jursey clear">
						<img src="images/carrom_tshirt.jpg" style="width:250px; height:200px" />
					</div>
					<img id="love_cr" src="images/love_carrom.jpg" style="width:250px; height:80px"/
