		...
		<div id="sportsbody" class="maincontent clear">
			<div class="navsports  clear">
				<ul>
					...
					<li><a id="active1" href="table_tennis.php">Table Tennis</a></li>
                    ...
                    <div class="pr_body clear">
                        <center>
						<form class="form" action="tab_profile.php" method="post" enctype="multipart/form-data" autocomplete="off">                          
						<table id="cr_tb">
	...
	<div class="sidebar clear">
		<div class="search">
			...
			<div id="side" class="samesidebar clear">
				<img src="images/tab_tshirt.jpg" style="width:253px"/>
				
			</div>
			<img src="images/tab_logo.png" style="width:253px; height:50px"/>
			<div id="side1" class="samesidebar clear">
					<div class="bd_jursey clear">
						<img src="images/tab_tshirt1.jpg" style="width:250px; height:200px" />
					</div>
					<img id="love_cr" src="images/love_tab.jpg" style="width:250px; height:80px"/
