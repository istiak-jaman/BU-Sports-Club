...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (preg_match("!image!",$_FILES['PHOTO']['type'])) {
            ...
            if (copy($_FILES['PHOTO']['tmp_name'], $photo_path)){
                ...
                $sql = 
                "INSERT INTO cricket (NAME, DEPARTMENT, SESSION, ROLL, REGISTRATION, EMAIL, MOBILE, DATE_OF_BIRTH, GENDER, ACTION, PHOTO ) "
                . "VALUES ('$username', '$dept', '$session', '$roll', '$reg', '$email', '$mbno', '$birth', '$sex', '$act', '$photo_path')";
	...
	<div class="contentsection templete clear">
		<div id="sportsbody" class="maincontent clear">
			<div class="navsports  clear">
				<ul>
					<li><a id="active1" href="cricket.php">Cricket</a></li>
                    ...
                    <div class="pr_body clear">
                        <center>
						<form class="form" action="cric_profile.php" method="post" enctype="multipart/form-data" autocomplete="off">                          
						<table id="cr_tb">
						<h1 id="th1" style="color:#6cc0cb">Create Your Player Profile.</h1>
                                ...
                                <tr id="cr_tr">
                                 ...
                                 <tr id="cr_tr">
                                    <td>Action</td>
                                    <td class="action">
                                        : <select id="cr_sel" name="ACTION">
                                            <option value="action">--Choose Your Action--</option>
                                            <option value="Bat">Batsman (Right Handed)</option>
                                            <option value="Bat">Batsman (Left Handed)</option>
                                            <option value="allround">All Rounder</option>
                                            <option value="Bowl">Bowler (Right arm fast)</option>
                                            <option value="Bowl">Bowler (Left arm fast)</option>
                                            <option value="Bowl">Bowler (Off break Spinner)</option>
                                            <option value="Bowl">Bowler (Leg break Spinner)</option>
                                        </select>
                                    </td>
                                </tr>
                                 <tr id="cr_tr">
