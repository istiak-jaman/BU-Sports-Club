...
<?php
	if (!isset($_GET['id'])) {
		echo "<meta http-equiv='refresh' content='0;URL=?id=omi'/>";
	}
    	...
    	<div class="cartoption">		
			<div class="cartpage">
				...
				<td>
					...
					<div class="shopping">
						<div class="shopleft">
							<a href="shop.php"> <img src="S_images/images/shop.png" alt="" /></a>
						</div>
						<div class="shopright">
							<a href="payment.php"> <img src="S_images/images/check.png" alt="" /></a>
						</div>
					</div>
    	</div>  	
       <div class="clear"></div>
